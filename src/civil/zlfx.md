...
$$
前期比重=\text{本期比重} \times { {\text{整体增长率}+1} \over {\text{部分增长率}+1} }
$$
...
选项单位：百分点或%
$$
比重差={\text{前期部分} \over \text{本期整体}} \times (\text{部分增长率}-\text{整体增长率})={a \over B} \times (R_1-R_2)
$$
...
$$
拉动增长={\text{部分增量} \over \text{整体前期}}
$$

$$
增量贡献率={\text{部分增量} \over \text{整体增量}}
$$
